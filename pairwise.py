...
class Pairwise(Dataset):
    ...
    def __init__(self, seq_dataset, **kargs):
        ...
        # Augment target and search images
    ...
    def parse_args(self, **kargs):
        # parameters for selecting train pairs
        cfg = {
            'pairs_per_seq': 10,
            'max_dist': 100,
            'exemplar_sz': 135,
    ...
    def __getitem__(self, index):
        ...
        exemplar_image = 263.0 * self.transform_z(exemplar_image)
        instance_image = 263.0 * self.transform_x(instance_image)
